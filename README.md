...
A small Android companion that forwards selected replyable notifications to [T3 Code Bridge for Even Realities G2](https://github.com/DeeJanuz/even-t3-bridge). Dictate and review replies on the glasses, then hand them back to the originating Android app.

**Public beta:** 0.1.2-beta.1. Android 9+ is required. This is an independent community project, not an official Even Realities or messaging-app integration.

## Install the beta

1. Set up the computer bridge using the [copyable installer skill](https://raw.githubusercontent.com/DeeJanuz/even-t3-bridge/main/skills/t3-bridge-deploy/SKILL.md) in your existing T3 Code agent. It handles Windows, macOS, or Linux prerequisites and startup, and provides your phone setup details.
...
5. In the T3 Code Bridge settings inside Even Hub, use **Android notifications → Pair Android companion**. Enter the resulting short-lived code and your **HTTPS bridge origin** in the Android companion, then pair.
